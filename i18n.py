...
CATALOG: dict[str, dict] = {
    "en": {
        ...
        "ui": {
            ...
            "status_error": "FAILED",
            "status_idle": "STANDBY",
            "progress_sources": "reading sources {done}/{total} \u00b7 {found} candidates",
            "progress_validating": "{done} of {total} tested \u00b7 {found} valid",
            "never": "never",
            ...
            "loading": "loading",
            "footer_full_list": "Full list: {routes} · header {header} · filters ?types= ?stable= ?country= ?sort= ?format=",
    ...
    "pt-BR": {
        ...
        "ui": {
            ...
            "progress_sources": "lendo as fontes {done}/{total} \u00b7 {found} candidatos",
            "progress_validating": "{done} de {total} testados \u00b7 {found} v\u00e1lidos",
            "never": "nunca",
            ...
            "loading": "carregando",
            "footer_full_list": "Lista completa: {routes} · header {header} · filtros ?types= ?stable= ?country= ?sort= ?format=",
            "footer_sync": "SYNC {time} · auto {seconds}s",
